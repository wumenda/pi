...
// Client-side mirrors of the pi-server experimental service contracts. Chord
// matches services by ID over the wire, so the descriptors must use identical
// IDs and compatible JSON shapes with the coding-agent implementations.
