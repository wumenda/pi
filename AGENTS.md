...
MCP Apps related features are documented under `docs/` (see `docs/MCP-Apps-概述.md` and `docs/MCP-Apps-skill-tool-iframe-方法论.md`). Read these first before working on MCP Apps features or answering MCP Apps questions.
